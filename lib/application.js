...
const NoopAuthenticator = require('./authenticator/noop-authenticator.js');
...
class Application {
			...
			.then(authResult => {
				...
				if (!match.handler.isAllowed(
					...
					return this._sendResponse(
						...
						authResult.actor, authResult.actor,
						requestUrl, httpRequest.headers);
				}
	 ...
	 */
	_sendResponse(
		httpResponse, method, match, response, requestActor, responseActor,
