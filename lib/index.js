 ...
 * @returns {Response|Object|Promise.<Response|Object>} Call response or a
 * promise of it. If resolves to an object, an HTTP 200 (OK) response is sent
 * with the object in the response body serialized as JSON. If resolves to
 * <code>null</code>, an HTTP 204 (No Content) is sent. The promise can be
 * rejected with an {@link external:Error} object, which will result in an HTTP
